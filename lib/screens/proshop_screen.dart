...
class ProshopScreen extends StatefulWidget {
  @override
  _ProshopScreenState createState() => _ProshopScreenState();
}

class _ProshopScreenState extends State<ProshopScreen> {
  String proshopCategoryId = "L47Xl6aZmnwvIJoI5E4L";
  String proshopLabel = "Pro shop";
  ...
  Widget build(BuildContext context) {
    ...
    categoryName = RestaurantServices.getCategoryName(
        categoryId: proshopCategoryId, context: context);
